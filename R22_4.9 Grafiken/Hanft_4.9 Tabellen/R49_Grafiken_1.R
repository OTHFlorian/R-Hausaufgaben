...
plot(x=airquality$Temp, y=airquality$Ozone,
     xlab="Temperatur  [\U{00B0}Fahrenheit]", ylab="\U00D8 Ozon  [ppb]",
     pch=16, col="#FFA50080", las=1, xlim=c(50,100), 
     main="Mehr Ozon an warmen Tagen", cex=(airquality$Wind/5))
...
legend("topleft", pch=16, col="orange", 
